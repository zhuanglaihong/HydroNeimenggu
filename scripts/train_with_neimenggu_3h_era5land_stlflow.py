...
LastEditTime: 2024-12-14 16:56:33
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/train_with_neimenggu_3h_era5land_stlflow.py
...
def config():
    ...
    project_name = os.path.join(
        "train_with_era5land", "train_with_neimenggu_3h_era5land_stlflow"
    )
