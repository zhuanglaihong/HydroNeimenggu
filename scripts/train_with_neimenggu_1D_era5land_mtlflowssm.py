...
LastEditTime: 2024-12-14 16:27:24
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/train_with_neimenggu_1D_era5land_mtlflowssm.py
...
def config():
    ...
    project_name = os.path.join(
        "train_with_era5land", "train_with_nmg_1D_era5land_mtlflowssm"
    )
    ...
    args = cmd(
        ...
        train_epoch=20,
        save_epoch=1,
        train_period=["2015-06-01", "2020-10-31"],
        test_period=["2020-10-31", "2023-10-31"],
        valid_period=["2020-10-01", "2023-10-31"],
