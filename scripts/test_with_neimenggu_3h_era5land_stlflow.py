...
LastEditTime: 2024-12-14 10:38:16
LastEditors: Wenyu Ouyang
Description:
FilePath: \HydroNeimeng\scripts\test_with_neimenggu_3h_era5land_stlflow.py
...
def config():
    ...
    args = cmd(
        ...
        stat_dict_file=os.path.join(
            RESULT_DIR,
            "train_with_nmg_3h_era5land_stlflow",
        ...
        weight_path=os.path.join(
            RESULT_DIR, "train_with_nmg_3h_era5land_stlflow", "best_model.pth"
        ),
