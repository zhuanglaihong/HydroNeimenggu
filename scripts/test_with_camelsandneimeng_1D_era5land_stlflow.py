...
LastEditTime: 2024-12-14 18:03:56
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/test_with_camelsandneimeng_1D_era5land_stlflow.py
...
def config():
    ...
    project_name = os.path.join(
        "test_with_era5land", "test_with_camelsandneimeng_1D_era5land_stlflow"
    )
    ...
    args = cmd(
        ...
        stat_dict_file=os.path.join(
            RESULT_DIR,
            "train_with_camelsandneimeng_1D_era5land_stlflow",
