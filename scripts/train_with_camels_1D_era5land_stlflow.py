...
LastEditTime: 2024-12-14 17:16:25
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/train_with_camels_1D_era5land_stlflow.py
...
show = pd.read_csv(
    os.path.join(pathlib.Path(__file__).parent.parent, "gage_ids/basin_us.csv"),
    dtype={"id": str},
)
...
def config():
    ...
    project_name = os.path.join(
        "train_with_era5land", "train_with_camels_1D_era5land_stlflow"
    )
