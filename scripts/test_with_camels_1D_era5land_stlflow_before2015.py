...
LastEditTime: 2024-12-14 20:51:33
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/test_with_camels_1D_era5land_stlflow_before2015.py
...
def config():
    ...
    project_name = os.path.join(
        "test_with_era5land", "test_with_camels_1D_era5land_stlflow_before2015"
    )
    ...
    args = cmd(
        ...
        test_period=["2001-02-01", "2015-10-31"],
        train_mode=False,
        stat_dict_file=os.path.join(
            RESULT_DIR,
            "train_with_camels_1D_era5land_stlflow",
        ...
        weight_path=os.path.join(
            RESULT_DIR, "train_with_camels_1D_era5land_stlflow", "best_model.pth"
        ),
