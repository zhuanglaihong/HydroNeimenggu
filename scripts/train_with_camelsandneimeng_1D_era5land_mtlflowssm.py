...
LastEditTime: 2024-12-14 17:20:29
LastEditors: Wenyu Ouyang
Description:
FilePath: /HydroNeimeng/scripts/train_with_camelsandneimeng_1D_era5land_mtlflowssm.py
...
def config():
    ...
    project_name = os.path.join(
        "train_with_era5land", "train_with_camelsandneimeng_1D_era5land_mtlflowssm"
    )
